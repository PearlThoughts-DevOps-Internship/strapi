...
resource "null_resource" "example" {
   triggers = {
    ...
    inline = [
      ...
      "echo 'HOST=${var.MAHESHR_HOST}' >> .env",
      "echo 'PORT=${var.MAHESHR_PORT}' >> .env",
      "echo 'APP_KEYS=${var.MAHESHR_APP_KEYS}' >> .env",
      "echo 'API_TOKEN_SALT=${var.MAHESHR_API_TOKEN_SALT}' >> .env",
      "echo 'ADMIN_JWT_SECRET=${var.MAHESHR_ADMIN_JWT_SECRET}' >> .env",
      "echo 'TRANSFER_TOKEN_SALT=${var.MAHESHR_TRANSFER_TOKEN_SALT}' >> .env",
      "echo 'DATABASE_CLIENT=${var.MAHESHR_DATABASE_CLIENT}' >> .env",
      "echo 'DATABASE_FILENAME=${var.MAHESHR_DATABASE_FILENAME}' >> .env",
      "echo 'JWT_SECRET=${var.MAHESHR_JWT_SECRET}' >> .env",
      "sudo npm install",
      "npm run build",
